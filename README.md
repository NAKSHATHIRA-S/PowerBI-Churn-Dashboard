...
## 🧠 Project Overview
This project is a Power BI dashboard built to analyze customer churn behavior in a telecom company. It helps identify key factors that influence customer retention and churn risk using interactive visualizations and KPIs.
...
- Demographic analysis (gender, senior citizens, partners)
- Subscription time distribution
- Payment methods & billing analysis
